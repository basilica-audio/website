<!-- Generated from overture/docs/manual.md on 2026-07-27 — do not hand-edit; re-run the manual sync described in website/README.md. -->
...
| **Gate** | Off / On | Off | – | Built-in noise gate (new in v0.3.0), placed at the very front of the wet chain - before Tight, before Drive - so hum and hiss never reach the clipper at all. Off by default; switching it on mid-note neither clicks nor mutes. The **dry** path (anything you blend in with Mix below 100%) is deliberately *not* gated: the gate is part of the pedal chain, the way an outboard gate in front of an amp would be. Adds no latency. |
